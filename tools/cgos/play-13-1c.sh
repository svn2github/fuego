...
# Script for playing Fuego on 13x13 CGOS with 1 thread / 2 GB

FUEGO="../../build/opt/fuegomain/fuego"
VERSION=$(cd ../..; svnversion) || exit 1
DEFAULT_NAME=Fuego-$VERSION-1c
...
cat <<EOF >config-13-1c.gtp
# This file is auto-generated by play-13-1c.sh. Do not edit.
...
# Use 2 GB for two trees (search and the init tree used for reuse_subtree)
uct_max_memory 2000000000
...
./cgos3.patched.tcl "$NAME" "$PASSWORD" \
  "$FUEGO --size 13 --config config-13-1c.gtp 2>/dev/stderr" \
  gracefully_exit_server-13-1c
