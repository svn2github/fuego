...
# Script for playing Fuego on 9x9 CGOS with 1 core / 100k playouts

FUEGO="../../build/opt-9/fuegomain/fuego"
VERSION=$(cd ../..; svnversion) || exit 1
DEFAULT_NAME=Fuego-$VERSION-100k-sim
...
cat <<EOF >config-9-100k.gtp
# This file is auto-generated by play-9-100k.sh. Do not edit.

go_param debug_to_comment 1
go_param auto_save $GAMES_DIR/$NAME-

# use default uct_max_memory 512000000
...
./cgos3.patched.tcl "$NAME" "$PASSWORD" \
  "$FUEGO --size 9 --config config-9-100k.gtp 2>/dev/stderr" \
  gracefully_exit_server-9-100k
