...
# Script for playing Fuego on 9x9 CGOS with 1 thread / 2 GB

FUEGO="../../build/opt-9/fuegomain/fuego --nobook"
...
cat <<EOF >config-9-1c-nobook.gtp
# This file is auto-generated by play-9-1c-nobook.sh. Do not edit.
...
./cgos3.patched.tcl "$NAME" "$PASSWORD" \
  "$FUEGO --size 9 --config config-9-1c-nobook.gtp 2>/dev/stderr" \
  gracefully_exit_server-9-1c-nobook
