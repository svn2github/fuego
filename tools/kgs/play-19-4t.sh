#!/bin/bash
# Script for playing Fuego on 19x19 KGS with 4 threads / 8 GB
...
cat <<EOF >config-19-4t.gtp
# This file is auto-generated by play-19-4t.sh. Do not edit.

go_param debug_to_comment 1
go_param auto_save $GAMES_DIR/$NAME-
go_sentinel_file stop-19-4t
...
verbose=t
engine=$FUEGO --size 19 --config config-19-4t.gtp $MAXGAMES_OPTION
reconnect=t
EOF
