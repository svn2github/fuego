...
BOOST_AUTO_TEST_CASE(GoBoardUpdaterTest_Setup)
{
    ...
    addBlack->Append(Pt(1, 2));
    addBlack->Append(Pt(1, 3));
    addBlack->Append(Pt(1, 4));
    addBlack->Append(Pt(1, 5));
    root->Add(addBlack);
    root->Add(addWhite);
    SgNode* child = new SgNode();
    addBlack = new SgPropAddStone(SG_PROP_ADD_BLACK);
    addWhite = new SgPropAddStone(SG_PROP_ADD_WHITE);
    addWhite->Append(Pt(2, 1));
    addWhite->Append(Pt(2, 2));
    addWhite->Append(Pt(2, 3));
    addWhite->Append(Pt(2, 4));
    addWhite->Append(Pt(2, 5));
    addBlack->Append(Pt(3, 1));
    child->Add(addBlack);
    child->Add(addWhite);
    child->AppendTo(root);
    GoBoard bd(19);
